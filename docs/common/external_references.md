...
- Query operators (`&`, `*`, projection, restriction): <https://docs.datajoint.com/core/datajoint-python/latest/query/operators/>
- DataJoint core concepts overview: <https://www.datajoint.com/docs/core/>
...
- Inputs: <https://suite2p.readthedocs.io/en/latest/inputs/>
- Outputs: <https://suite2p.readthedocs.io/en/latest/outputs/>
...
- ADAMACS DISK schema chapter: `Analysis -> Schema Chapters -> disk`
